...
add_requires("entt", "vulkan-headers", "vulkansdk", "vulkan-hpp", "glfw", "glm", "gtest", "spdlog", "nlohmann_json")
...
target("EngineSquared")
    ...
    add_packages("entt", "vulkansdk", "glfw", "glm", "spdlog", "nlohmann_json")
...
for _, file in ipairs(os.files("tests/**.cpp")) do
    ...
    target(name)
        ...
        add_packages("entt", "vulkansdk", "glfw", "glm", "gtest", "spdlog", "nlohmann_json")
        add_links("gtest")
